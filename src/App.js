              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    building scalable SaaS applications using Node.js,
                    Express.js, and microservices architecture. Specialized in
                    REST API development, Redis caching, Kafka-based
                    event-driven systems, and WebSocket integration for
                    real-time features.
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              ...
              >
                API Version: {roundedExperience}.0
              </span>
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            </div>
          </div>
